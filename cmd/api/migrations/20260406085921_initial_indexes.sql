...
CREATE UNIQUE INDEX CONCURRENTLY IF NOT EXISTS idx_roles_slug_unique ON roles (
    slug,
    COALESCE(
        organization_id,
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_addresses_defaults ON addresses (
    organization_id,
    is_default_shipping,
    is_default_billing
);

CREATE UNIQUE INDEX CONCURRENTLY IF NOT EXISTS uq_addresses_default_shipping ON addresses (organization_id)
WHERE
    is_default_shipping = TRUE;

CREATE UNIQUE INDEX CONCURRENTLY IF NOT EXISTS uq_addresses_default_billing ON addresses (organization_id)
WHERE
