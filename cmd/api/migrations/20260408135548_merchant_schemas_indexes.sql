...
CREATE UNIQUE INDEX CONCURRENTLY IF NOT EXISTS uq_categories_slug ON categories (
    slug,
    coalesce(
        organization_id,
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_warehouses_organization_id_id ON warehouses (organization_id, id);
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_inventories_low_stock ON inventories (warehouse_id, quantity_available)
WHERE
...
CREATE UNIQUE INDEX CONCURRENTLY IF NOT EXISTS uq_attributes_slug ON attributes (
    slug,
    coalesce(
        organization_id,
        '00000000-0000-0000-0000-000000000000'::uuid
...
DROP INDEX CONCURRENTLY IF EXISTS idx_warehouses_organization_id_id;
